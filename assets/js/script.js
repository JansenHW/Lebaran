...
// Dirubah 
const pengirim = "Jansenn Uhuyy";
const nomorWa = "6282292040714" // awalan nomor 0 harus di awalin 62
const textWa = "Ah bisa aja kamu"
const pesan = `Selamat hari lebaran Abangg, Semoga kebahagiaanmu tahun ini seluas antrean beli baju Lebaran,
rezekimu selancar tangan ngambil kue di meja tamu! 😜,
dan semoga kesabaranmu makin tebal kayak dompet pas baru dapet THR (meskipun nanti langsung tipis lagi 🤣).✨

Mohon maaf lahir dan batin, ya Abang Sayangg! Semoga Lebaran ini penuh berkah dan tawa! 🤗🎉,
 dan nggak ketahuan kalau ngambil daging opor paling gede! 🤣✨"" `;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    imageUrl: "/assets/img/sticker.GIF",
    imageHeight: 120,
    title: 'Wajib Isi Nama Abang Dulu Yaaa!!',
    ...
    preConfirm: () => {
      ...
      if (!login) {
        Swal.showValidationMessage(`Nahh kan, isi dulu atuh Abangg :(`)
      }
      return { login }
    }
  }).then((result) => {
    ...
    let txt = `Halo, Abangg ${result.value.login}, Nama Abang tuh gemesss kek orangnyaa hehe ${namaAwal.toUpperCase()}, ${pesan}`;
